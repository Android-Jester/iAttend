...
################################################################################
## Form generated from reading UI file 'camera_2jJYhGl.ui'
##
...
"}")
        ...
        self.label_28.setGeometry(QRect(40, 50, 31, 30))
        ...
        self.btn_exit_cam_connect.setGeometry(QRect(20, 110, 151, 51))
        font2 = QFont()
...
"}")
        ...
        self.exit_cam_ip.setGeometry(QRect(20, 40, 561, 50))
        self.exit_cam_ip.setMinimumSize(QSize(0, 50))
        self.exit_cam_ip.setMaximumSize(QSize(16777215, 50))
...
"}")
        ...
        self.btn_exit_cam_disconect.setGeometry(QRect(190, 110, 161, 51))
...
"padding-left:5px;")
        ...
        self.comboBox.setGeometry(QRect(370, 110, 211, 51))
        self.comboBox.setMinimumSize(QSize(0, 51))
        self.comboBox.setMaximumSize(QSize(16777215, 51))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Camera 2", None))
