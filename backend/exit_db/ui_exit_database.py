...
################################################################################
## Form generated from reading UI file 'exit_databaseOEOpnS.ui'
##
...
"}")
        ...
        self.mysql.setGeometry(QRect(190, 40, 95, 20))
...
"}")
    ...
    def retranslateUi(self, Database):
        ...
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("Database", u"Database Logout", None))
        ...
        self.sqlite.setText(QCoreApplication.translate("Database", u"SQLite3", None))
