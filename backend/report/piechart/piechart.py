...
class Piechart(FigureCanvas):
    def __init__(self):
        pass
    def piechart(self,data:list,title:str,colors:list,startangle,area,dpi,labeldistance,pctdistance):
        ...
        plt.xlabel(xlabel=dict(zip(data[0], data[1])),color='white',size= 15,labelpad= 25)
