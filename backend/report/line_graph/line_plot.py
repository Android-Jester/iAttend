...
class Line_plot(FigureCanvas):
    ...
    def plot_graph(self,y_values:list,title:str,label_:str,y_label:str,x_label:str,area: int,dpi: int,color: str,marker: str):
        ...
        plt.plot(y_values,label=label_,marker=marker,color=color)
        ...
        plt.savefig('C:\\ProgramData\\iAttend\\data\\reports\\visualize\\linegraph.png',dpi = dpi, edgecolor='none')
