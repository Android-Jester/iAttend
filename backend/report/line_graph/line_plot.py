...
class Line_plot(FigureCanvas):
    ...
    def plot_graph(self,y_values:list,title:str,label_:str,y_label:str,x_label:str):
        ...
        plt.savefig(r'backend\\report\\line_graph\\line_plot.png',dpi = 300, edgecolor='none')
        plt.savefig(r'backend\\report\\line_graph\\line_plot.pdf',dpi = 300, edgecolor='none')
