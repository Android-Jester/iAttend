...
class UIFunctions(QMainWindow):
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.ui.drop_shadow_layout.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(42, 44, 111, 255), stop:0.521368 rgba(28, 29, 73, 255)); border-radius: 10px;")
    ...
    def uiDefinitions(self):
        ...
        self.ui.drop_shadow_layout.setGraphicsEffect(self.shadow)
